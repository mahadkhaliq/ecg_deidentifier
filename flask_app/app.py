...
# Define functions for processing files as previously created...
...
def index():
    ...
    return render_template('index.html', input_folder=input_folder, output_folder=output_folder)

@app.route('/success')
def success():
    return "Files have been processed and saved successfully!"
